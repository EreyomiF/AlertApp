  ...
  posts.forEach((post) => {
    ...
    postElement.innerHTML = `
        <div class="incident-img-div">
          <img src="${post.image}" alt="Incident Image" class="incident-img" />
        </div>
       ...
       <div class="incident-content">
             ...
             <div class="title">${
               post.headline
             }<span class="deletebtn"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M7 21C6.45 21 5.97917 20.8042 5.5875 20.4125C5.19583 20.0208 5 19.55 5 19V6H4V4H9V3H15V4H20V6H19V19C19 19.55 18.8042 20.0208 18.4125 20.4125C18.0208 20.8042 17.55 21 17 21H7ZM17 6H7V19H17V6ZM9 17H11V8H9V17ZM13 17H15V8H13V17Z" fill="#1D1B20"/>
             ...
             <div class="description">${post.desc}</div></div>
             
             <div class="card-footer">
               <div class="label">${post.category?.toUpperCase()}</div>
               <div class="location">
               <span>lattitude: ${
                 Math.round(post.postlocation.latitude * 10000) / 10000
               },</span>  
               <span>longitude: ${
                 Math.round(post.postlocation.longitude * 10000) / 10000
               }</span>
               <div>
...
document.addEventListener("DOMContentLoaded", function () {
  if (window.cordova) {
    ...
    document.addEventListener(
      ...
      function () {
        ...
        document.querySelector(".submitbtn").addEventListener("click", () => {
          ...
          // Check and request permission in Cordova environment
    ...
    document.querySelector(".submitbtn").addEventListener("click", () => {
      ...
      // Proceed to get the location directly in the browser environment
